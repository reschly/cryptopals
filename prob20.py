...
# Matasano Problem 20
# Break fixed-nonce CTR using stream cipher analysis
from prob1 import base64toRaw
from prob18 import raw_xor, aes_ctr
from prob3 import calculateMG
from prob19 import printSolution
...
def solve20():
    ...
    # Author's note: this clearly didn't solve the first byte correctly
    # likely because the space character is highly-weighted but extremely
    # unlikely in this position.
